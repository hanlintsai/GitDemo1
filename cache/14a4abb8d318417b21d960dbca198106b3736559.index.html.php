<?php
/* Smarty version 3.1.30, created on 2017-09-01 21:26:03
  from "C:\wamp64\www\bootstrap\templates\index.html" */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.30',
  'unifunc' => 'content_59a95feb5b8986_78592834',
...
function content_59a95feb5b8986_78592834 (Smarty_Internal_Template $_smarty_tpl) {
?>
<!DOCTYPE html>
<html lang="en">
	<head>
		...
		<div class="container-fluid">
			...
			<div class="row">
				<div class="col-lg-3 col-md-6 col-sm-12 justify-content-center">
					<a href="#" type="button" class="btn btn-primary btn-block" id="button0">按鈕</a>
				</div>
				<div class="col-lg-3 col-md-6 col-sm-12 justify-content-center">
					<a href="#" type="button" class="btn btn-success btn-block" id="button1">按鈕</a>
				</div>
				<div class="col-lg-3 col-md-6 col-sm-12 justify-content-center">
					<a href="#" type="button" class="btn btn-info btn-block" id="button2">按鈕</a>
				</div>
			</div>
			<div class="row">
				<div class="col-lg-3 col-md-6 col-sm-12 justify-content-center">
					<a href="#" type="button" class="btn btn-warning btn-block" id="button3">按鈕</a>
				</div>
				<div class="col-lg-3 col-md-6 col-sm-12 justify-content-center">
					<a href="#" type="button" class="btn btn-danger btn-block" id="button4">按鈕</a>
				</div>
				<div class="col-lg-3 col-md-6 col-sm-12 justify-content-center">
					<a href="#" type="button" class="btn btn-link btn-block" id="button5">按鈕</a>
				</div>
			</div>
